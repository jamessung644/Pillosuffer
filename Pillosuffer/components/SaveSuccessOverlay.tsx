 ...
 */
export default function SaveSuccessOverlay({ show, message = '약 정보가 저장되었어요' }: Props) {
  if (!show) return null

  return (
    <div className="fixed inset-0 z-[100] bg-white/95 backdrop-blur-sm flex flex-col items-center justify-center animate-fade-in">
      ...
      <p className="mt-2 text-sm text-gray-500 animate-slide-up">잠시 후 메인 화면으로 이동합니다</p>
