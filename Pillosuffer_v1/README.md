...
입력·오류 처리·근거 격리·위조 출처 차단·DB 오류 중단·LLM 미호출 등 자동 테스트 31개를 통과했습니다. 별도 로컬 브라우저 테스트는 320/1440px의 원문 있음·근거 부족·혼합 결과, 오류·재시도 등 9개 시나리오를 확인합니다. 결과 화면의 인증은 가상 응답으로 검사하므로 실제 Google 로그인 검증은 아닙니다.
