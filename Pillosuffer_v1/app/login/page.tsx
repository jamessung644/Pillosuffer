...
function LoginContent() {
  ...
  async function handleGoogleLogin() {
    ...
    try {
      ...
      setError('로그인을 시작하지 못했습니다. 연결 상태를 확인하고 다시 시도해 주세요.')
      setLoading(false)
    }
  }
  ...
  return (
    <div className="page-padding flex flex-col min-h-screen bg-white">
      ...
      <div className="flex justify-end pt-2">
        <button
          onClick={() => router.replace(next === '/result' ? '/food' : next === '/profile' ? '/profile' : '/')}
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-8">
        ...
        <h1 className="text-4xl font-black text-gray-900">뭐무꼬</h1>
      ...
      <div className="space-y-3 pb-2">
        ...
        <p className="text-center text-sm text-gray-600 pt-3 leading-relaxed">
          약 정보와 검사 기록은 이 기기에 저장됩니다.<br />
          분석 결과를 확인하려면 로그인이 필요합니다.
        </p>
