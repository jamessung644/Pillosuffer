...
export default function BottomNav() {
  ...
  return (
    <nav aria-label="주 메뉴" className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full sm:max-w-md bg-white border-t border-gray-200 px-2 pt-2.5 safe-area-bottom z-50">
      <div className="flex">
        {NAV_ITEMS.map(item => {
